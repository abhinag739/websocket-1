var AuctionSocket = function(user_id, user_name, auction_id, form) {
  ...
  AuctionSocket.prototype.initBinds.call(this);  
...
AuctionSocket.prototype.initBinds = function() {
  ...
  this.form.submit(function(e) {
    e.preventDefault();
    AuctionSocket.prototype.sendBid.call(_this, $("#bid_value").val());
  });
...
AuctionSocket.prototype.sendBid = function(value) {
  ...
  var template = "bid {{auction_id}} {{user_name}} {{user_id}} {{value}}";
